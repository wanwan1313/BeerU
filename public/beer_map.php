        ...
        <div class="row world-eachs mx-auto position-relative">
            ...
            <div class="eu" id='eu'>
                ...
                <div class="eu_flags">
                    ...
                    <div class="flag flag2 position-absolute">
                        <img class='mug' name='法國' src="../images/map/SVG/mug_fc.svg" alt="">
                    </div>
                    ...
                    <div class="flag flag3  position-absolute">
                        <img class='mug' name='比利時' src="../images/map/SVG/mug_bl.svg" alt="">
                    </div>
                    ...
                    <div class="flag flag4 position-absolute">
                        <img class='mug' name='挪威' src="../images/map/SVG/mug_nw.svg" alt="">
                    </div>
                    ...
                    <div class="flag flag5 position-absolute">
                        <img class='mug' name='丹麥' src="../images/map/SVG/mug_dm.svg" alt="">
                    </div>
                    ...
                    <div class="flag flag6 position-absolute">
                        <img class='mug' name='德國' src="../images/map/SVG/mug_gm.svg" alt="">
                    </div>
                    ...
                    <div class="flag flag7 position-absolute">
                        <img class='mug' name='瑞典' src="../images/map/SVG/mug_sw.svg" alt="">
                    </div>
                    ...
                    <div class="flag flag8 position-absolute">
                        <img class='mug' name='義大利' src="../images/map/SVG/mug_it.svg" alt="">
                    </div>
            ...
            <div class="as" id='as'>
                ...
                <div class="as_flags">
                    ...
                    <div class="flag flag1 position-absolute">
                        <img class='mug' name='日本' src="../images/map/SVG/mug_jp.svg" alt="">
                    </div>
                    <div class="deco2 position-absolute animatable fadeInUp">
                        <img id='deco' src="../images/map/SVG/deco_rs.svg" alt="">
                    </div>
                    <div class="flag flag2 position-absolute">
                        <img class='mug' name='俄羅斯' src="../images/map/SVG/mug_rs.svg" alt="">
                    </div>
                    <div class="deco4 position-absolute animatable fadeInUp">
                        <img id='deco' src="../images/map/SVG/deco_vm.svg" alt="">
                    </div>
                    <div class="flag flag4  position-absolute">
                        <img class='mug' name='越南' src="../images/map/SVG/mug_vm.svg" alt="">
                    </div>
                    <div class="deco3 position-absolute animatable fadeInUp">
                        <img id='deco' src="../images/map/SVG/deco_sp.svg" alt="">
                    </div>
                    <div class="flag flag3  position-absolute">
                        <img class='mug' name='新加坡' src="../images/map/SVG/mug_sp.svg" alt="">
                    </div>
                </div>
                <!-- 標題 -->
            ...
            <div class="au" id='au'>
                ...
                <div class="au_flags">
                    ...
                    <div class="flag flag1 position-absolute">
                        <img class='mug' name='澳洲' src="../images/map/SVG/mug_au.svg" alt="">
                    </div>
                    <div class="flag2 deco2 position-absolute animatable fadeInUp">
                        <img id='deco' src="../images/map/SVG/deco-nz.svg" alt="">
                    </div>
                    <div class="flag flag2 position-absolute">
                        <img class='mug' name='紐西蘭' src="../images/map/SVG/mug_nz.svg" alt="">
                    </div>
                </div>
                <!-- 標題 -->
