...
<div class="content">
     <!-- 登入測試 -->
     <form class='col-md-5 px-0 pl-md-0 mr-0 order-2 order-md-1' action="" name='event_join' method="post" novalidate onsubmit="event_submit(); return false;">
          <div class="form-title">姓名 <input type="text" class='col-10' name='p0_name' placeholder="啤啤" style='letter-spacing: 0;' required></div>
          <div class="form-title">電話 <input class='col-10' type="tel" name='p0_mobile' placeholder="0912-345-678" required></div>
