    ...
    <section class="event join">
        ...
        <div class="need_login animatable fadeInUp">
            ...
            <div class="col all-button flex-nowrap px-0">
                <!-- 登入會員 -->
                <button class='btn_join full d-block mx-auto w-75 mb-2 col-md-5' type='submit'
                    disabled="disabled" style='    cursor: not-allowed; '>已額滿</button>
                <div class="d-flex w-75 mx-auto col-md-5 memo-check lh15 px-0 align-items-baseline">
                    <div class="memo mx-auto d-inline">*敬請加入關注，隨時掌握《啤女》最新動態</div>
                </div>
                <!-- 返回上頁 -->
