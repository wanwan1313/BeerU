...
$t_SQL = "SELECT * FROM `products` WHERE `type_sid` = 46 AND `sid` !=  $psid AND `sid` != $c_row_sid  ORDER BY RAND() LIMIT 1";
$t_row = $pdo->query($t_SQL)->fetch();
$t_row_sid = $t_row['sid'];

$b_SQL = "SELECT * FROM `products` WHERE `type_sid` = 46 AND `sid` !=  $t_row_sid AND $c_row_sid ORDER BY RAND() LIMIT 1";
