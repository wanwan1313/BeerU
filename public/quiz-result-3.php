    ...
    <div class="container">
        <div class="row">
            <div class="col-12 result-info-wrap mt-5">
                <p class="result-title">適合你的精釀啤酒類型：<span>淡色拉格</span></p>
                <p class="result-info">
                    有一種人容易在酒後就直接睡著，沒有太多其餘的對談與行為。這樣的人個性隨和，且心胸開闊，比較不會因為小事與他人斤斤計較。你們看似能和很多人好好相處，但實則多與人沒有交流。你們通常容易滿足，也對生活現狀感到安逸，對未來沒有過多要求與追求，把日子過的順利就是你們最大的心願。
                    酒精對你們來說，就像放鬆劑一樣，喝完就能安心睡覺。</p>
            </div>
        </div>
    </div>
    <div class="container">
