    ...
    <div class="container">
        <div class="row">
            <div class="col-12 result-info-wrap mt-5">
                <p class="result-title">適合你的精釀啤酒類型：<span>淡色愛爾</span></p>
                <p class="result-info">
                    喝完酒後，有些人會變得亢奮，由心而發的高興與快樂讓你們可以笑不停、唱不停，甚至跳舞跳不停。這樣的你個性開朗，正向積極，有義氣但也有溫柔的一面。你們喜歡與人溝通，透過認識新朋友拓展自己的視野。你們熱愛生活，也對未來充滿信心與期待。
                    酒精對你們來說，是放大感官的輔助。</p>
            </div>
        </div>
    </div>
