...
if (wd != 'none') {
    ...
    if ($(window).width() < 700) {
        ...
        let ph = $('.parts').height()
        $('.parts').removeClass('display-none').css('bottom', fh + 20 + 'px').removeClass('top625');
    ...
    $(window).resize(function() {
        if ($(window).width() < 700) {
            ...
            let fh = $('.beer-warning').height()
            let ph = $('.parts').height()
            $('.parts').removeClass('display-none').addClass('display-flex').css('bottom', fh + 20 + 'px').removeClass('top625');
            $('.phone-option').removeClass('display-none')
        } else {
            $('.parts').addClass('display-none');
            $('.phone-option').addClass('display-none');
...
if ($(window).height() > 815) {
    ...
    $('.parts').css('bottom', fh + 20 + 'px').removeClass('top625');
}
$(window).resize(function() {
    let fh = $('.beer-warning').height()
    if ($(window).height() > 815) {
